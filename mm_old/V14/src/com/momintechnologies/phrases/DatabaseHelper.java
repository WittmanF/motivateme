...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    private static final String CREATE_TABLE_PHRASES = "CREATE TABLE phrases(phrase_id INTEGER PRIMARY KEY,phrase_text TEXT,phrase_author TEXT,phrase_category TEXT,created_at DATETIME)";
    private static final String DATABASE_NAME = "Phrases";
    private static final int DATABASE_VERSION = 2;
    private static final String KEY_CREATED_AT = "created_at";
    private static final String KEY_PHRASE_AUTHOR = "phrase_author";
    private static final String KEY_PHRASE_CATEGORY = "phrase_category";
    ...
    public void addPhrase(Phrase phrase)
    {
        ...
        contentvalues.put("phrase_author", phrase.getPhraseAuthor());
        contentvalues.put("phrase_category", phrase.getPhraseCategory());
    ...
    public List getAllPhrases()
    {
        ...
        if (cursor.moveToFirst())
        {
            do
            {
                ...
                phrase.setPhraseAuthor(cursor.getString(2));
                phrase.setPhraseCategory(cursor.getString(3));
                Log.d("DatabaseHelper", (new StringBuilder()).append(phrase.getPhraseId()).append(phrase.getPhraseText()).append(phrase.getPhraseAuthor()).append(phrase.getPhraseCategory()).toString());
    ...
    public Phrase getPhrase(int i)
    {
        ...
        obj = ((SQLiteDatabase) (obj)).query("phrases", new String[] {
            "phrase_id", "phrase_text", "phrase_author", "phrase_category"
        ...
        if (obj != null)
        {
            ...
            phrase = new Phrase(Integer.parseInt(((Cursor) (obj)).getString(0)), ((Cursor) (obj)).getString(1), ((Cursor) (obj)).getString(2), ((Cursor) (obj)).getString(3));
        }
        return phrase;
    }
    ...
    {
        sqlitedatabase.execSQL("CREATE TABLE phrases(phrase_id INTEGER PRIMARY KEY,phrase_text TEXT,phrase_author TEXT,phrase_category TEXT,created_at DATETIME)");
    }
