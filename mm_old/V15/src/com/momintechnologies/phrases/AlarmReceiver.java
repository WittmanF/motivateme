...
public class AlarmReceiver extends BroadcastReceiver
{
    ...
    public void createNotification(Context context)
    {
        ...
        obj = (new android.app.Notification.Builder(context)).setContentTitle("Motivate Me!").setContentText("Good Morning.").setSmallIcon(0x7f020058).setContentIntent(((PendingIntent) (obj))).build();
