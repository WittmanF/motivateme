    ...
    implements android.app.TimePickerDialog.OnTimeSetListener
{
    ...
    {
        Object obj = new Intent(context, com/example/phrases/AlarmReceiver);
        ...
        Log.d("MyActivity", (new StringBuilder("Set alarmManager.setRepeating to: ")).append(calendar.getTime().toLocaleString()).toString());
    }
